    ...
    <div class="product-price-and-shipping product-line-info {if $product.has_discount}has-discount{/if}">
      ...
      {if $product.has_discount}
          ...
          {if $product.discount_type === 'percentage'}
            <span class="discount discount-percentage tbproduct-discount-price">-{$product.discount_percentage_absolute}</span>
          {else}
            <span class="discount discount-amount tbproduct-discount-price">-{$product.discount_to_display}</span>
          {/if}
      {/if}
  ...
  <div class="product-line-grid-right product-line-actions col-md-5 col-xs-12">
    <div class="row">
      ...
      <div class="col-md-10 col-xs-7">
        <div class="row">
          <div class="col-md-12 col-xs-12 qty tb-addtocart-qyt">
          ...
          <div class="col-md-12 col-xs-12 tb-addtocart-price price">
      ...
      <div class="col-md-2 col-xs-1 text-xs-right tb-cart-delete-icon-wrapper">
