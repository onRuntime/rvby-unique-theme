 ...
 *}
{strip}
<div class="tbproduct-wrapper list">
	{block name='product_thumbnail'}
		<div class="tbproduct-image col-sm-3">
			{if $product.cover}
	...
	{/block}
	<div class="tbproductdescription-button-wrapper col-sm-9">
		...
		<div class='tball-product-btn-list'>
