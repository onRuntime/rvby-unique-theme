...
<div class="tbcms-newsletter-wrapper">
						...
						<div class="tbnewsleeter-input-button-wraper">
							...
							<div class="tbnewsleteer-btn-wrapper">
								<button class='btn btn-primary' name="submitNewsletter" type="submit">
									<span class='tbnewslatter-btn-title hidden-sm-down'>{l s='Subscribe' d='Shop.Theme.Actions'}</span> 
									<span class='tbnewslatter-btn-title hidden-md-up'>{l s='OK' d='Shop.Theme.Actions'}</span> 
