...
{strip}
  <div id="search_filters">
    ...
    {* <div class="tbleft-right-title-wrapper">
    ...
    <div class="tbserach-filter-wrapper">
      <div class="tbsearch-filter-button-wrapper">
          ...
          {if $facet.displayed}
            <div class="facet col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12">
              <div class="tbfilter-dropdown-wrapper">
                ...
                {/foreach}
                <div class="title hidden-lg-up tbfilter-search-types-title clearfix" data-target="#facet_{$_expand_id}">
                  <p class="h6 facet-title">{$facet.label}</p>
                  <div class="float-xs-right tbdropdown-btn">
                      <i class="material-icons">&#xE313;</i>
                  </div>
                </div>
                ...
                {if $facet.widgetType !== 'dropdown'}
                  ...
                  {block name='facet_item_other'}
                    <ul id="facet_{$_expand_id}" class="tbfilter-search-types-dropdown">
