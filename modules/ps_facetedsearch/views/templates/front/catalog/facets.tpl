...
{if $displayedFacets|count}
  <div id="search_filters">
    <div class="tbserach-filter-wrapper">
      ...
      {block name='facets_clearall_button'}
        ...
        {/if}
      {/block}
      <div class="tbsearch-filter-content-wrapper">
        {foreach from=$displayedFacets item="facet"}
          <section class="facet col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12">
            <div class="tbfilter-dropdown-wrapper">
              ...
              <div class="title hidden-lg-up tbfilter-search-types-title clearfix" data-target="#facet_{$_expand_id}" data-toggle=""{if !$_collapse} aria-expanded="true"{/if}>
                <p class="h6 facet-title">{$facet.label}</p>
                <span class="float-xs-right tbdropdown-btn">
                    <i class="material-icons">&#xE313;</i>
                </span>
              </div>
              ...
              {if in_array($facet.widgetType, ['radio', 'checkbox'])}
                {block name='facet_item_other'}
                  <ul id="facet_{$_expand_id}" class="tbfilter-search-types-dropdown{if !$_collapse} in{/if}">
