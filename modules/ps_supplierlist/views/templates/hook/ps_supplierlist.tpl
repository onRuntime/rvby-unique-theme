...
{strip}
<div id="search_filters_suppliers" class='tbfilter-supplier-list-wrapper'>
  <div class="facet">
    <div class="tbleft-right-title-wrapper">
      {if $display_link_supplier}
      <a class="tbleft-right-title facet-label" href="{$page_link}" title="{l s='Suppliers' d='Shop.Theme.Catalog'}">{/if}
    ...
    <div class="tbserach-filter-suppliers tbside-panel-dropdown">
      {if $suppliers}
