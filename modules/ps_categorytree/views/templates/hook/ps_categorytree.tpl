...
<div class="block-categories hidden-lg-down">
  <ul class="category-top-menu tbside-panel-dropdown">
    <li class="tb-category-title-wrapper">
      <a class="tb-main-category-title" href="{$categories.link nofilter}">{$categories.name}</a>
      <div class='tbleft-right-title-toggle'>
        <i class='material-icons'>&#xe313;</i>
      </div>
    </li>
    <li class="tb-leftcategory-wrapper">{categories nodes=$categories.children}</li>
  </ul>
</div>
{/if}
{/strip}