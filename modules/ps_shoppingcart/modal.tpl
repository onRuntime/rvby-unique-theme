 ...
 *}
{strip}
<div id="blockcart-modal" class="modal fade tb-addtocart-msg-wrapper" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close tb-addtocart-close" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-body tb-addtocart-content-part">
				<div class="row">
					<div class="col-md-6 divide-right">
						<div class="row tb-addtocart-image-name-wrapper">
							<div class="col-md-6 tb-addtocart-product-image">
								<img class="product-image" src="{$product.cover.medium.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
							</div>
							<div class="col-md-6 tb-addtocart-product-name">
								<h6 class="h6 product-name">{$product.name}</h6>
								<p class="tb-addtocart-price">{$product.price}</p>
					...
					<div class="col-md-6 tb-addtocart-content">
